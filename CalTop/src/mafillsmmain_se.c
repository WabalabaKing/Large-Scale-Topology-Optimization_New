...
static double *co1,*xboun1,*coefmpc1,*xforc1,*xload1,*xbody1,*cgr1,
    ...
    *gradCompl1,*elCompl1,*elCG1,*eleVol1, *lam1, *fn0_out1;
...
void mafillsmmain_se(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,
		   ...
		   double *eleVol, double *lam, double *fn0_out){
...
// next line is to be inserted in a similar way for all other paralell parts
	...
	eleVol1=eleVol, lam1=lam, fn0_out1=fn0_out;
