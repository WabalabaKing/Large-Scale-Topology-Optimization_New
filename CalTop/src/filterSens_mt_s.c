...
//       filter_sens_pthread_onepass_bin.c -o filter_sens_onepass_bin
// -----------------------------------------------------------------------------
                                  ...
                                  long long nnz_total)
{
    ...
    while(1){
        size_t n1=fread(drow_block,sizeof(int),   BLOCK_SIZE,frow);
        size_t n2=fread(dcol_block,sizeof(int),   BLOCK_SIZE,fcol);
