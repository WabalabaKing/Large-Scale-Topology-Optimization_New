...
void FORTRAN(resultsmech_se,(double *co,ITG *kon,ITG *ipkon,char *lakon,ITG *ne,
	  ...
	  double *dxstiff,ITG *ialdesi,double *xdesi,double *design, double *penal));
...
void results_se(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,
	     ...
	     double *fint,ITG *ishapeenergy,char *typeboun,double *fn0_out,double *design,double *penal);
