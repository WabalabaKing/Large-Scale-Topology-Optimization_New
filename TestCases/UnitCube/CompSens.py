...
def main():
    ...
    ap.add_argument("-i", "--input", default="UC", help="Job/input name without extension (default: SCB)")
    ap.add_argument("-p", "--penal", type=float, default=5.0)
    ap.add_argument("-r", "--radius", type=float, default=0.5)
    ap.add_argument("-f", "--filternnz", type=int, default=3)
    ap.add_argument("--pexp", type=int, default=10)
    ap.add_argument("--sigmin", type=float, default=1)
    ap.add_argument("--sigrelax", type=float, default=0.00001)
    ...
    ap.add_argument("--max-elems", type=int, default=6, help="Limit number of elements")
