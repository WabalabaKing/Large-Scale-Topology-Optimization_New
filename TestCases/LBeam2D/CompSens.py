...
def main():
    ...
    ap.add_argument("-r", "--radius", type=float, default=0.06)
    ap.add_argument("-f", "--filternnz", type=int, default=300)
    ap.add_argument("--pexp", type=int, default=30)
    ap.add_argument("--sigmin", type=float, default=100)
    ap.add_argument("--sigrelax", type=float, default=0.1)
    ap.add_argument("--h", type=float, default=1e-3, help="Constant absolute perturbation (default 1e-6)")
