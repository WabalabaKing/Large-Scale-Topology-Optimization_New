...
volfrac = 0.56
vol = volfrac #We are constraining volume instead of Volfrac
############Problem
InputFileName="MBB"
nDV = 192955
...
while penalty < penaltyEnd:
   ...
   evalFun1 = ExternalRun("Direct",f"calTop.exe {InputFileName} -p {penalty} -r {rmin} -f {nnz} --cg_eval NO", False)
   ...
   #con2 = Function("Topop","Direct/objectives.csv",TableReader(0,3,(1,0),(None,None),","))
   #con2.addInputVariable(var,"Direct/volume_sens.csv",TableReader(None,2,(1,0),(None,None),","))
   ...
   #driver.addLowerBound(fun1,volfrac,1)
