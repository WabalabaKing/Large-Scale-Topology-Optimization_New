...
with open('density.dat', 'w') as file:
   file.write("__X__")
x0=1.0* np.ones(nDV,dtype=float)

var = InputVariable(x0, ArrayLabelReplacer("__X__", "\n"), 0, np.ones(nDV,dtype=float), lb=0.001, ub=1.0)

evalFun1 = ExternalRun("Direct",f"calTop.exe {InputFileName} -p {penalty} -r {rmin} -f {nnz} --pexp {pexp} --sigmin {sigmax} --sigrelax {sigrelax}")
evalFun1.addConfig("density.dat")
evalFun1.addData(InputFileName+".inp")
#evalFun1.addData("skinElementList.nam")
evalFun1.addData("/home/prateek/Documents/GitHub/Large-Scale-Topology-Optimization/TestCases/StressCon/Mesh/dnnz.bin")
evalFun1.addData("/home/prateek/Documents/GitHub/Large-Scale-Topology-Optimization/TestCases/StressCon/Mesh/drow.bin")
evalFun1.addData("/home/prateek/Documents/GitHub/Large-Scale-Topology-Optimization/TestCases/StressCon/Mesh/dval.bin")
evalFun1.addData("/home/prateek/Documents/GitHub/Large-Scale-Topology-Optimization/TestCases/StressCon/Mesh/dcol.bin")
evalFun1.addData("/home/prateek/Documents/GitHub/Large-Scale-Topology-Optimization/TestCases/StressCon/Mesh/dsum.bin")
...
strcon.addInputVariable(var,"Direct/stress_sens.csv",TableReader(None,None,(1,0),(None,None),","))


driver = IpoptDriver()
driver.addObjective("min", fun1, 1)
#driver.addUpperBound(con,0.2)
driver.addUpperBound(strcon,1.0,1e-15)
optIter = 100
...
nlp.set(warm_start_init_point = 'no' ,
            ...
            adaptive_mu_kkterror_red_iters = 12, 
